...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 [_FL] = LAYOUT(
      ...
      _______, KC_LEFT, KC_DOWN, KC_RGHT, KC_MPLY, KC_MSTP, KC_ASTR, KC_SLSH, KC_HOME, KC_PGUP, KC_LEFT, KC_RGHT, _______,
      _______, KC_VOLD, KC_MUTE, KC_VOLU,  RGB_HUD, RGB_HUI,  KC_PLUS, KC_UNDS, KC_END, KC_PGDN, KC_DOWN, _______, _______,
